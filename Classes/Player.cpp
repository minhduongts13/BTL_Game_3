...
void Player::update(float delta)
{
    ...
    //{ // Kiểm tra nếu PhysicsBody còn tồn tại
...
{
    if (hp <= 0)
        return; // Nếu đã chết thì không nhận sát thương nữa
    ...
    auto revertColor = CallFunc::create([this]()
...
void Player::increaseSpeed()
{
    ...
    this->scheduleOnce([this](float dt)
                       { this->resetSpeed(); }, 15.0f, "reset_speed");
}
...
void Player::attack2()
{
    ...
    auto sprite = Sprite::create(this->lastDirection ? "Knight/fire0.png" : "Knight/fire0_flip.png");
