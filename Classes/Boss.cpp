...
void Boss::attack1() {
    ...
    if (isleft) {
        ...
        this->target = Vec2(rightHole.x, rightHole.y - 300);
    }
    else {
        this->right->setFlippedX(false);
        this->setFlippedX(false);
        this->setPosition(rightHole);
        this->target = Vec2(leftHole.x, leftHole.y - 300);
    }
    ...
    auto startAttack = CallFunc::create([this, isleft]() {
        ...
        auto moveAction = MoveTo::create(1.5f, this->target);
...
void Boss::DieAnimation() {
    ...
    this->setVisible(true);
    this->setRotation(0);
    this->setPosition(Vec2(7050, 800));
    ...
    auto hideBoss = CallFunc::create([this]() {
        ...
        //this->getPhysicsBody()->setCategoryBitmask(0x108);
        this->getPhysicsBody()->setDynamic(false);
